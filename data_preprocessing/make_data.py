...
def create_train_data(train_start=750, test_start=1800, is_train=True):
    ...
    # 加载sale数据
    sale_data = pd.read_csv('../input/m5-forecasting-accuracy/sales_train_validation.csv', dtype=SALE_DTYPES)
...
sale_data = create_train_data(train_start=1, is_train=True)
